...
const tagColors: Record<string, string> = {
  ...
  "Application Security": "bg-emerald-500/15 text-emerald-700 dark:text-emerald-300",
  "Product Engineering": "bg-violet-500/15 text-violet-700 dark:text-violet-300",
  ...
  return (
    <div className="absolute inset-0 overflow-hidden bg-gradient-to-br from-sky-950 via-blue-800 to-cyan-500">
      ...
      <div className="absolute bottom-5 left-5 right-5">
        ...
        <p className="mt-2 line-clamp-3 max-w-md font-[family-name:var(--font-headings)] text-2xl font-bold text-white sm:text-3xl">
          {post.title}
        </p>
      </div>
    </div>
