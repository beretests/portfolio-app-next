...
(
  ...
  '[{"name":"React","icon":"React"},{"name":"Javascript","icon":"Javascript"},{"name":"Nextjs","icon":"Nextjs"},{"name":"Python","icon":"Python"},{"name":"Html5","icon":"Html5"},{"name":"CSS3","icon":"CSS3"},{"name":"Supabase","icon":"Supabase"},{"name":"Docker","icon":"Docker"},{"name":"Kubernetes","icon":"Kubernetes"},{"name":"Cloudflare","icon":"Cloudflare"},{"name":"Nginx","icon":"Nginx"},{"name":"Tailwind","icon":"Tailwind"},{"name":"Typescript","icon":"Typescript"},{"name":"ReactNative","icon":"ReactNative"},{"name":"Postgresql","icon":"Postgresql"},{"name":"Mysql","icon":"Mysql"},{"name":"NodeJs","icon":"NodeJs"},{"name":"K6","icon":"K6"},{"name":"Azure","icon":"Azure"},{"name":"AWS","icon":"AWS"},{"name":"Selenium","icon":"Selenium"},{"name":"Playwright","icon":"Playwright"},{"name":"Terraform","icon":"Terraform"},{"name":"Ansible","icon":"Ansible"},{"name":"Git","icon":"Git"},{"name":"Postman","icon":"Postman"},{"name":"Power Apps","icon":"PowerApps"},{"name":"Power Automate","icon":"PowerAutomate"},{"name":"Dataverse","icon":"Dataverse"},{"name":"Power Fx","icon":"PowerFx"},{"name":"Azure Functions","icon":"AzureFunctions"},{"name":"Azure Key Vault","icon":"AzureKeyVault"},{"name":"Microsoft Entra ID","icon":"EntraId"},{"name":"Microsoft 365","icon":"Microsoft365"},{"name":"SharePoint","icon":"SharePoint"},{"name":".NET","icon":"DotNet"},{"name":"C#","icon":"CSharp"},{"name":"PowerShell","icon":"PowerShell"},{"name":"Azure DevOps","icon":"AzureDevOps"},{"name":"Microsoft Graph","icon":"MicrosoftGraph"},{"name":"Java","icon":"Java"},{"name":"Redux","icon":"Redux"},{"name":"GitLab","icon":"GitLab"}]'::jsonb
)
